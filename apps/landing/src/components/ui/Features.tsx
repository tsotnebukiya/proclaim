...
export default function Features() {
  return (
    <section
      aria-label="proClaim Features for Banks"
      id="solutions"
      ...
      <div className="grid grid-cols-1 gap-12 md:grid-cols-4 md:gap-0">
        ...
        <div className="col-span-2 my-auto px-2">
          ...
          <p className="mt-2 text-3xl font-semibold tracking-tighter text-balance text-gray-900 md:text-4xl">
            Single‑pane console for claims and settlement
          </p>
          <p className="mt-4 text-balance text-gray-700">
            Real‑time claim status, funding checks, and bulk actions in a single
            view. Maker/checker controls and a complete audit trail make STP
        ...
        <div className="col-span-2 my-auto px-2">
          ...
          <p className="mt-2 text-3xl font-semibold tracking-tighter text-balance text-gray-900 md:text-4xl">
            On‑chain settlement with tokenized cash
          </p>
          <p className="mt-4 text-balance text-gray-700">
            Smart contracts settle approved claims using a contract registry of
            banks and tokens. Only encrypted claim data and hashes land
            on‑chain; events provide immutable auditability and finality.
          </p>
        </div>
        <div className="relative col-span-2 flex items-center justify-center overflow-hidden">
        ...
        {/* C) AI Copilot for off-chain claims */}
        <div className="col-span-2 my-auto px-2">
          <h2 className="relative text-lg font-semibold tracking-tight text-orange-500">
            AI Copilot for off‑chain claims
            <div className="absolute top-1 -left-[8px] h-5 w-[3px] rounded-r-sm bg-orange-500" />
          </h2>
          <p className="mt-2 text-3xl font-semibold tracking-tighter text-balance text-gray-900 md:text-4xl">
            Off‑chain claims, handled by AI
          </p>
          <p className="mt-4 text-balance text-gray-700">
            AI ingests emails/PDFs and ISO/SWIFT, matches counterparties,
            computes amounts, and assembles artifacts (e.g., MT566). It stages a
            settlement‑ready claim and posts a receipt hash—your one step is
            approval.
          </p>
        </div>
        <div className="relative col-span-2 flex items-center justify-center overflow-hidden">
            ...
            <div className="relative flex flex-col items-center justify-center">
              <Orbit
                ...
                orbitingObjects={[
                  ...
                  >
                    <RiMailOpenFill className="z-10 size-5 text-gray-900" />
                  ...
                  <div
                    ...
                    className="relative flex items-center justify-center"
                  >
                    <RiFileTextFill className="z-10 size-5 text-gray-900" />
                    <div className="absolute size-10 rounded-full bg-white/50 ring-1 shadow-lg ring-black/5"></div>
                    <div className="absolute -top-5 left-4">
                      <div className="flex gap-1">
                  ...
                  <div
                    ...
                    className="relative flex items-center justify-center"
                  >
                    <RiExchangeFundsFill className="z-10 size-5 text-gray-900" />
                    <div className="absolute size-10 rounded-full bg-white/50 ring-1 shadow-lg ring-black/5"></div>
                    <div
